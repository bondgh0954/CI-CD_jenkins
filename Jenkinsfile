        ...
        stage('pushing image'){
            steps{
                script{
                    ...
                    withCredentials([usernamePassword(credentialsId: 'dockerhub-credentials', usernameVariable: 'USER', passwordVariabel: 'PASS')]){
                        sh "echo ${PASS} | username -u ${USER} --password-stdin"
        ...
        stage('commit version changes'){
            steps{
                script{
                    ...
                    withCredentials([usernamePassword(credentialsId: 'github-credentials', usernameVariable: 'USER', passwordVariabel: 'PASS')]){
